...
_page_select_callback = CallbackData("ms_select_page", "ms_id", "page_id")
_accept_changes_callback = CallbackData("ms_accept", "ms_id")
_finish_selection_callback = CallbackData("ms_finish", "ms_id")
...
class InlineMultiselect(CustomInlineKeyboard):
    ...
    def get_by_id(ms_id: Union[int, str]):
        return InlineMultiselect._keyboard_by_id[str(ms_id)]
    ...
    def __init__(self,
        ...
        InlineMultiselect._keyboard_by_id[self.id] = self
