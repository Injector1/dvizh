...
import googleapiclient.discovery as yAPI


class SportsRUParser(BaseParser):
    base_url = 'https://www.youtube.com/@MatchTV/videos'
    ...
    def __init__(self, telegraf_service: TelegrafService):
        ...
        youtube = yAPI.build(api_service_name, api_version, developerKey=DEVELOPER_KEY)
